...
pub struct Bn_382GParameters;

impl ModelParameters for Bn_382GParameters {
    type BaseField = Fp;
    type ScalarField = Fq;
}

pub type Affine = GroupAffine<Bn_382GParameters>;
pub type Projective = GroupProjective<Bn_382GParameters>;

impl SWModelParameters for Bn_382GParameters {
    /// COEFF_A = 0
    const COEFF_A: Fp = field_new!(Fp, BigInteger384([0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
