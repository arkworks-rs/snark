    ...
    C: ConstraintSynthesizer<E::Fr>,
{
    ...
    let c1_acc = VariableBaseMSM::multi_scalar_mul_affine(c1_aux_source, &aux_assignment);
    ...
    let c2_inputs_acc = VariableBaseMSM::multi_scalar_mul_affine(c2_inputs_source, &input_assignment);
    let c2_aux_acc = VariableBaseMSM::multi_scalar_mul_affine(c2_aux_source, &aux_assignment);
    ...
    let g_inputs_acc = VariableBaseMSM::multi_scalar_mul_affine(g_inputs_source, &h_input);
    let g_aux_acc = VariableBaseMSM::multi_scalar_mul_affine(g_aux_source, &h_aux);
