...
impl CurvePair for MNT46 {
    type PairingEngineTick = MNT4_753;
    type PairingEngineTock = MNT6_753;
    type PairingGadgetTick = MNT4753PairingGadget;
    type PairingGadgetTock = MNT6753PairingGadget;
    const TICK_CURVE: &'static str = "MNT4_753";
    const TOCK_CURVE: &'static str = "MNT6_753";
}
struct MNT64;
impl CurvePair for MNT64 {
    type PairingEngineTick = MNT6_753;
    type PairingEngineTock = MNT4_753;
    type PairingGadgetTick = MNT6753PairingGadget;
    type PairingGadgetTock = MNT4753PairingGadget;
