            ...
            if $limbs == 12 {
                unsafe {
                    let modulus_with_inv = [
                        P::MODULUS.0[0], P::MODULUS.0[1], P::MODULUS.0[2], P::MODULUS.0[3],
                        P::MODULUS.0[4], P::MODULUS.0[5], P::MODULUS.0[6], P::MODULUS.0[7],
                        P::MODULUS.0[8], P::MODULUS.0[9], P::MODULUS.0[10], P::MODULUS.0[11],
                        P::INV,
                    ];
                    let mut r = [0u64; 12];
                    crate::fields::arithmetic::modmul768(((self.0).0).as_ptr(), ((other.0).0).as_ptr(), modulus_with_inv.as_ptr(), r.as_mut_ptr());
        ...
        fn square_in_place(&mut self) -> &mut Self {
            ...
            if $limbs == 12 {
                unsafe {
                    ...
                    let mut r = [0u64; 12];
                    crate::fields::arithmetic::modmul768(((self.0).0).as_ptr(), ((self.0).0).as_ptr(), modulus_with_inv.as_ptr(), r.as_mut_ptr());
                    (self.0).0.copy_from_slice(&r[..]);
                    return self;
                }
            }
