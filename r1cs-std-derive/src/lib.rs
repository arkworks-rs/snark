...
#[proc_macro_derive(ConditionalEqGadget, attributes(ConstraintField))]
pub fn derive_conditional_eq_gadget(input: TokenStream) -> TokenStream {
    ...
    quote!(
        impl #impl_generics ConditionalEqGadget<ConstraintF> for #name #ty_generics
        #where_clause
        {
            type Output = Self;
