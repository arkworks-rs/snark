...
fn poseidon_perm_sbox<T:PoseidonParameters> (state: &mut Vec<T::Fr>) {
...
pub fn poseidon_engine_sbox<T: PoseidonParameters>(input: &mut Vec<T::Fr>) -> T::Fr {
    ...
    poseidon_perm_sbox::<T>(&mut state);
